...
class CustomTextField: UITextField {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let phText = self.placeholder {
            self.attributedPlaceholder = NSAttributedString(string: phText, attributes: [kCTForegroundColorAttributeName as NSAttributedStringKey: UIColor(netHex: 0xB3B3B3)])
        }
